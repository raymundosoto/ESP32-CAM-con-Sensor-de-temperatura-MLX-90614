...
//Datos de WiFi
const char* ssid = "XXXXXX";  // Aquí debes poner el nombre de tu red
const char* password = "XXXXXXX";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
//const char* mqtt_server = "192.XXX.XXX.XX"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
